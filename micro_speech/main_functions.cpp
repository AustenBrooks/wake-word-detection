...
void loop() {
  ...
  // printf("model output [t=%6lu]: <%4d, %4d, %4d, %4d>\n", time_us_32(), output->data.int8[0], output->data.int8[1], output->data.int8[2], output->data.int8[3]);
  ...
  if (is_new_command) {
    ...
    else if (found_command == "bamboozle") {
      ST7735_FillRectangle(0, 90, ST7735_WIDTH, 70, ST7735_GREEN);
